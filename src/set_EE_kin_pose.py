...
from gazebo_msgs.srv import GetLinkState, ApplyBodyWrench, SetModelState
...
def sub3_cb(msg):
	...
	qL_start[0] = msg.position[0]
	qL_start[1] = msg.position[1]
	qL_start[2] = msg.position[2]
	qL_start[3] = msg.position[3]
	qL_start[4] = msg.position[4]
	qL_start[5] = msg.position[5]

	qR_start[0] = msg.position[10]
	qR_start[1] = msg.position[11]
	qR_start[2] = msg.position[12]
	qR_start[3] = msg.position[13]
	qR_start[4] = msg.position[14]
	qR_start[5] = msg.position[15]
...
if __name__ == '__main__':
	...
	sub3 = rospy.Subscriber("/joint_states", JointState, callback=sub3_cb)
